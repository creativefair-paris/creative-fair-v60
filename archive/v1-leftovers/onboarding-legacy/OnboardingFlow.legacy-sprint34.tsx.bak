// LEGACY — Sprint 34
// Conservé pour référence historique. Réf Sprint 36.B (enrichissement Ma Marque).
// NE PAS importer depuis l'app. L'onboarding actif utilise components/onboarding/OnboardingFlow.tsx
// (Sprint 36.A — flux inversé Marcus, 4 questions).
//
...
export function OnboardingFlowLegacySprint34() {
